...
- `POST /api/v1/outbox-events/outbox-001/requeue-requests`
...
- `GET /api/v1/outbox-consumer/metrics`
- `GET /api/v1/outbox-consumer/window-metrics`
- `GET /api/v1/outbox-consumer/health`
- `GET /api/v1/outbox-consumer/receipts`
- `POST /api/v1/outbox-consumer/pruning-runs`
...
- [`Home`](wiki-drafts/Home.md): 전체 지도와 현재 릴리스 상태
- `Glossary`: 계정, 지갑, 원장, 거래, 정산 등 용어집
- [`Domain-Rules`](wiki-drafts/Domain-Rules.md): 도메인 불변식과 정책
- [`Architecture-Decisions`](wiki-drafts/Architecture-Decisions.md): ADR 목록과 결정 배경
...
- [`QA-Scenarios`](wiki-drafts/QA-Scenarios.md): QA 관점의 시나리오와 경계값
- [`Release-Notes`](wiki-drafts/Release-Notes.md): 릴리스별 변경 사항과 알려진 리스크
- [`MCP-and-Skills`](wiki-drafts/MCP-and-Skills.md): 사용할 MCP 서버와 커스텀 스킬 목록
