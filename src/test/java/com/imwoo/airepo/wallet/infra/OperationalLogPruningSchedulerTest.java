...
class OperationalLogPruningSchedulerTest {
    ...
    void runsPruningWithConfiguredRetention() {
        ...
        OperationalLogPruningPolicy pruningPolicy = new OperationalLogPruningPolicy(
                30,
                180,
                new OperationalAlertPolicy(15, 45)
        );
        ...
        when(pruningService.prune(Duration.ofDays(30), Duration.ofDays(180), Duration.ofDays(45)))
        ...
        verify(pruningService).prune(Duration.ofDays(30), Duration.ofDays(180), Duration.ofDays(45));
    }
}
