...
- 최신 병합 기준: `main`
- 최신 완료 기능: Requeue Approval Workflow
- 현재 릴리스 후보: `v0.7.0`
- 아직 미완료: Kafka/RabbitMQ/SQS adapter, consumer idempotency, pruning 실행 이력, external alert channel, broker-specific Testcontainers 정책, 승인 반려 정책
