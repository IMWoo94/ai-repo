...
- Stale cleanup artifacts — 완료된 end-user JWT 구현 계획과 죽은 `sync-codex-skills.py`를 제거하고, `spring-security-oauth2-jose` 직접 의존성을 starter transitive 의존성으로 정리(ADR-0073)
